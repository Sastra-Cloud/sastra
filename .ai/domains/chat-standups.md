# Domain: chat-standups

Project chat, live chat streams, standups, AI digesting, and cron jobs.
...
- `lib/chat/access.ts`
- `lib/chat/actions.ts`
- `lib/chat/channel-members.test.ts`
- `lib/chat/channel-members.ts`
- `lib/chat/direct.test.ts`
- `lib/chat/direct.ts`
